    ...
    <div className="w-64">
      ...
      <div className="space-y-2">
        ...
        <div className="text-sm text-gray-600">
          ...
          <p>Location: {dog.location?.city || 'Unknown'}</p>
        </div>
        ...
        <Link
          href={`/dogs/${dogId}`}
          className="block w-full text-center bg-primary-600 text-white py-2 rounded-lg hover:bg-primary-700 transition-colors font-medium mt-3"
        >
          View Profile
        </Link>
      </div>
